...
def process_video(args, detector=None):
    ...
    manifest = {
        ...
        "privacy_policy": {
            ...
            "detector_class_labels_are_localization_only": True,
        },
        "frames": [],
                ...
                manifest["frames"].append(
                    {
                        ...
                        "pet_label": "pet",
                        "detector_pet_class": detection.get("label", "unknown"),
                        "detector_pet_class_confidence": float(detection["confidence"]),
